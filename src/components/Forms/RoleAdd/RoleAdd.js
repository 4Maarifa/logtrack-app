...
class RoleAdd extends Component {
  ...
  renderCompany = company => (
    <div>
      <img width="20" height="20" alt={company.name + '\'s logo'} src={company.logoURL} />
      {company.name}
    </div>);
  ...
  printSelectedCompany = () => {
    if (!!this.state.selectedCompany) {
      return (<span>
        Selected company:
        <img width="20" height="20" alt={this.state.selectedCompany.name + '\'s logo'} src={this.state.selectedCompany.logoURL} />
